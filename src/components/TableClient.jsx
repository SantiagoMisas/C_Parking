  ...
  return (
    <section>
      <form onSubmit={agregarCliente} className="flex_wrap">
        <input className="form_table_input" placeholder="Cedula" type="text" value={cedula}
              onChange={(e)=> setcedula(e.target.value)}/>
        <input className="form_table_input" placeholder="Nombre" type="text" value={nombre}
        ...
        <input className="form_table_input" placeholder="Correo" type="text" value={correo}
              onChange={(e)=> setCorreo(e.target.value)}/>
        <input className="form_table_input" placeholder="Celular" type="text" value={celular}
